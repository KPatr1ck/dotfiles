...
export PATH=/home/cxj/anaconda3/bin:$PATH

# shortcut for conda env activate and deactivate
sra() {
...
. /home/cxj/anaconda3/etc/profile.d/conda.sh


WIN_IP=`cat /etc/resolv.conf | grep nameserver | awk '{ print $2 }'`
function proxyon() {
    export http_proxy=$WIN_IP:10809
    export https_proxy=$WIN_IP:10809
    echo 'Proxy On...'
}
